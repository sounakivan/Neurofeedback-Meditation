...
[CustomEditor(typeof(ScreenRipple))]
[CanEditMultipleObjects]
public class ScreenRippleEditor : Editor {
    ...
    SerializedProperty ringThickness;

    SerializedProperty fadeAmount;

    SerializedProperty falloffDistance;
    ...
    private void OnEnable()
    {
        ...
        falloffDistance = serializedObject.FindProperty("falloffDistance");
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(ringSize);
